...
const IssueDetailsDialogue = ({
  ...
  // Safe check for user and membership
  const canChange =
    user?.id === issue.reporter?.clerkUserId ||
    membership?.role === "drg:admin";
  ...
  <DialogContent>
    <DialogHeader>
        ...
        <DialogTitle>{issue.title}</DialogTitle></div>
...
export default IssueDetailsDialogue;